...
for count in range(3):
    ...
    os.system(f"python Hyperband_search.py {param_r} {param_eta} 20 0 {c}> logs_hyperband/{output_name}")
...
for count in range(3):
    ...
    for c in combinations_list:
        ...
        os.system(f"python Hyperband_search.py {param_r} {param_eta} 20 1 {c}> logs_hyperband/{output_name}")
